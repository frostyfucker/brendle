...
export const MessageCircle: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M7.9 20A9 9 0 0 0 12 22a9 9 0 0 0 4.1-1.9l4.9 1.9-1.9-4.9A9 9 0 0 0 22 12a9 9 0 0 0-2-5.1A9 9 0 0 0 12 3a9 9 0 0 0-9 9c0 2.1.7 4 1.9 5.6l-1.9 4.9Z"/></svg>
);
...
export const Sparkles: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M12 3a6 6 0 0 0 9 9 9 9 0 1 1-9-9Z"/><path d="M18 11.5A2.5 2.5 0 0 1 15.5 9a2.5 2.5 0 0 1 4 0 2.5 2.5 0 0 1 0 4 2.5 2.5 0 0 1-4 0Z"/><path d="m22 2-1.5 1.5"/><path d="M13.5 20.5 12 22"/><path d="m2 2 1.5 1.5"/><path d="M20.5 13.5 22 12"/><path d="m3.5 10.5 1.5 1.5"/></svg>
);

export const ThumbsUp: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M7 10v12"/><path d="M18 10V4a2 2 0 0 0-2-2H8a2 2 0 0 0-2 2v6H4a2 2 0 0 0-2 2v8a2 2 0 0 0 2 2h12l5-5V10Z"/></svg>
);
...
export const TreePine: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="m17 14 -4.5 4.5a.5.5 0 0 1-.71 0L7 14h-2a1 1 0 0 1-1-1v-2a1 1 0 0 1 1-1h2l4.5-4.5a.5.5 0 0 1 .71 0L17 10h2a1 1 0 0 1 1 1v2a1 1 0 0 1-1 1h-2z"/><path d="m12 12-4.5 4.5"/><path d="m16.5 7.5-4.5 4.5"/></svg>
);

export const RefreshCw: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><polyline points="23 4 23 10 17 10"/><polyline points="1 20 1 14 7 14"/><path d="M20.49 9A9 9 0 0 0 5.64 5.64L1 10m22 4l-4.64 4.36A9 9 0 0 1 3.51 15"/></svg>
);
...
export const VideoOff: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M16 16v1a2 2 0 0 1-2 2H3a2 2 0 0 1-2-2V7a2 2 0 0 1 2-2h2m5.66 0H14a2 2 0 0 1 2 2v3.34l1 1L23 7v10"/><line x1="2" x2="22" y1="2" y2="22"/></svg>
);
...
export const Square: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><rect width="18" height="18" x="3" y="3" rx="2" ry="2"/></svg>
);
...
export const Lightbulb: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M15 14c.2-1 .7-1.7 1.5-2.5C17.7 10.3 18 9.2 18 8A6 6 0 0 0 6 8c0 1.2.3 2.3 1.5 3.5.7.7 1.3 1.5 1.5 2.5"/><path d="M9 18h6"/><path d="M10 22h4"/></svg>
);

export const PiggyBank: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M15.5 13.5c0-2.5-2-4-2-4s-2 1.5-2 4c0 1.4 1.1 2.5 2.5 2.5S15.5 14.9 15.5 13.5z"/><path d="M9.5 9.5c.6.6 1.4 1 2.5 1s1.9-.4 2.5-1"/><path d="M18.8 20.3c.8-1.5 1.2-3.2 1.2-5 0-5-4-9-9-9s-9 4-9 9c0 1.8.4 3.5 1.2 5a7.3 7.3 0 0 0 3.3 3.7c.4.2.8.3 1.3.3h6.4c.5 0 .9-.1 1.3-.3a7.3 7.3 0 0 0 3.3-3.7z"/></svg>
);

export const Palette: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><circle cx="13.5" cy="6.5" r=".5" fill="currentColor"/><circle cx="17.5" cy="10.5" r=".5" fill="currentColor"/><circle cx="8.5" cy="7.5" r=".5" fill="currentColor"/><circle cx="6.5" cy="12.5" r=".5" fill="currentColor"/><path d="M12 2C6.5 2 2 6.5 2 12s4.5 10 10 10c.926 0 1.648-.746 1.648-1.688 0-.437-.18-.835-.47-1.125-.29-.289-.69-.469-1.128-.469h-.296c-.44 0-.84-.18-1.13-.47-.29-.29-.47-.69-.47-1.13v-.293c0-.44-.18-.84-.47-1.13-.29-.29-.69-.47-1.13-.47h-.294c-.44 0-.84-.18-1.13-.47-.29-.29-.47-.69-.47-1.13v-.293c0-.44-.18-.84-.47-1.13-.29-.29-.69-.47-1.13-.47h-.294c-.439 0-.84-.18-1.13-.47-.29-.29-.47-.69-.47-1.13v-.293c0-.44-.18-.84-.47-1.13-.29-.29-.69-.47-1.13-.47h-.294a1.686 1.686 0 0 1-1.648-1.688C2 6.5 6.5 2 12 2z"/></svg>
);
...
export const HeartHandshake: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M19 14c1.49-1.46 3-3.21 3-5.5A5.5 5.5 0 0 0 16.5 3c-1.76 0-3 .5-4.5 2-1.5-1.5-2.74-2-4.5-2A5.5 5.5 0 0 0 2 8.5c0 2.3 1.5 4.05 3 5.5l7 7Z"/><path d="M12 5 9.04 7.96a2.17 2.17 0 0 0 0 3.08v0c.82.82 2.13.82 2.94 0l.06-.06L12 11l2.94-2.94c.82-.82 2.13-.82 2.94 0v0a2.17 2.17 0 0 1 0 3.08L12 11"/></svg>
);

export const UserCog: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><circle cx="18" cy="15" r="3"/><circle cx="9" cy="7" r="4"/><path d="M12 15h-1a4 4 0 0 0-4 4v2"/><path d="m21.7 16.4-.9-.3"/><path d="m15.2 13.9-.9-.3"/><path d="m16.6 18.7.3-.9"/><path d="m19.1 12.2.3-.9"/><path d="m19.6 18.7-.4-1"/><path d="m14.7 12.2-.4-1"/><path d="m16.8 12.3-.9.4"/><path d="m14.3 18.6-.9.4"/></svg>
);

export const PauseCircle: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><circle cx="12" cy="12" r="10"/><line x1="10" x2="10" y1="15" y2="9"/><line x1="14" x2="14" y1="15" y2="9"/></svg>
);

export const ListTodo: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M12 20h.01"/><path d="M17 20h.01"/><path d="M7 20h.01"/><rect x="3" y="5" width="6" height="6" rx="1"/><path d="m3 17 2 2 4-4"/><rect x="15" y="5" width="6" height="6" rx="1"/><path d="m15 17 2 2 4-4"/></svg>
);

export const Archive: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M21 8V5a2 2 0 0 0-2-2H5a2 2 0 0 0-2 2v3"/><path d="M21 8v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8"/><path d="M10 12h4"/></svg>
);

export const Bot: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M12 8V4H8"/><rect width="16" height="12" x="4" y="8" rx="2"/><path d="M2 14h2"/><path d="M20 14h2"/><path d="M15 13v-2a1 1 0 0 0-1-1h-4a1 1 0 0 0-1 1v2"/><path d="M12 18v-4"/><path d="M8 18v-2"/><path d="M16 18v-2"/></svg>
);
...
export const Mic: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M12 1a3 3 0 0 0-3 3v8a3 3 0 0 0 6 0V4a3 3 0 0 0-3-3z"/><path d="M19 10v2a7 7 0 0 1-14 0v-2"/><line x1="12" x2="12" y1="19" y2="22"/></svg>
);
...
export const Google: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor" {...props}><path d="M21.35,11.1H12.18V13.83H18.69C18.36,17.64 15.19,19.27 12.19,19.27C8.36,19.27 5,16.25 5,12C5,7.9 8.2,4.73 12.19,4.73C14.04,4.73 15.3,5.5 15.9,6.18L18.03,4.21C16.32,2.59 14.4,1.86 12.19,1.86C6.96,1.86 3,6.57 3,12C3,17.54 7.06,22.14 12.19,22.14C17.5,22.14 21.5,18.33 21.5,11.33C21.5,10.74 21.45,10.91 21.35,11.1Z"/></svg>
);

export const CloudUpload: React.FC<IconProps> = (props) => (
